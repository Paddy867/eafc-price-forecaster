...
def Show_graphing_page():
    ...
    if cleaned_df is not None:
        ...
        filtered_market_prices_dates = filtered_market_prices[(filtered_market_prices >= start_date) & (filtered_market_prices <= end_date)]
...
# To run: streamlit run "C:\Users\paddy\OneDrive - Lancing College\NEA\Code\v4\GUI with date selection v1.py"