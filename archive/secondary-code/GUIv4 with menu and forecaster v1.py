...
def Show_forecaster_page():
        ...
        days_to_forecast = st.sidebar.slider("Number of Days to Forecast:", min_value = 1, max_value = 30, value = 7)
        ...
        cleaned_df['Data Type'] = 'Historical'
        forecast_df['Data Type'] = 'Forecast'
        plot_df = pd.concat([filtered_df[['Date_time', 'Price'], forecast_df], ignore_index=True)
...
# To run: streamlit run "C:\Users\paddy\OneDrive - Lancing College\NEA\Code\v4\GUIv4 with menu and forecaster v1.py"