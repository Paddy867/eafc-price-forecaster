...
def read_directory_to_df(directory_path):
    try:
        ...
        combined_data = pd.concat(all_data, ignore_index=True) #Takes the all_data array full of dataframes and converts it into one single dataframe
...
def main():
    ...
    #read data from the directory into the 
    ...
    if df is not None:
        ...
        print("No data in given directory")
